...
\[
\frac{\partial \pmb{\psi}_{LM_{r^2_Y}}}{\partial \pmb{\alpha}_Y} = 
	\begin{bmatrix}
...
2\cdot r_{Y_i}(\pmb{\alpha}_Y) \frac{\partial r_{Y_i}(\pmb{\alpha}_Y)}{\partial \pmb{\alpha}_Y}
	\begin{bmatrix}
		...
		t_{1i} \\
		t_{2i} \\
		2(r^2_{Y_i}(\pmb{\alpha}_Y) - \pmb{\beta_{Y}}\pmb{T}_i)\\
 	\end{bmatrix} 
\]
...
\[
\frac{\partial \pmb{\psi}_{LM_{r_{YX}}}}{\partial \pmb{\alpha}_Y} = 
	\begin{bmatrix}
		r_{X_i}(\pmb{\alpha}_X) \frac{\partial r_{Y_i}(\pmb{\alpha}_Y)}{\partial \pmb{\alpha}_Y} \\
		t_{1i}  \cdot r_{X_i}(\pmb{\alpha}_X) \frac{\partial r_{Y_i}(\pmb{\alpha}_Y)}{\partial \pmb{\alpha}_Y}\\
		t_{2i} \cdot  r_{X_i}(\pmb{\alpha}_X) \frac{\partial r_{Y_i}(\pmb{\alpha}_Y)}{\partial \pmb{\alpha}_Y}\\
		2\cdot (r_{Y_i}(\pmb{\alpha}_Y)r_{X_i}(\pmb{\alpha}_X) - \pmb{\beta}_{YX}\pmb{T}_i)\cdot r_{X_i}(\pmb{\alpha}_X) \frac{\partial r_{Y_i}(\pmb{\alpha}_Y)}{\partial \pmb{\alpha}_Y}
 	\end{bmatrix}= r_{X_i}(\pmb{\alpha}_X) \frac{\partial r_{Y_i}(\pmb{\alpha}_Y)}{\partial \pmb{\alpha}_Y}
	\begin{bmatrix}
		1\\
		t_{1i} \\
		t_{2i} \\
		2(r_{Y_i}(\pmb{\alpha}_Y)r_{X_i}(\pmb{\alpha}_X) - \pmb{\beta}_{YX}\pmb{T}_i)\\
 	\end{bmatrix} 
\]
And $\frac{\partial \pmb{\psi}_{LM_{r_{YX}}}}{\partial \pmb{\alpha}_X}$ is computed in a similar manner:
\[
\frac{\partial \pmb{\psi}_{LM_{r_{YX}}}}{\partial \pmb{\alpha}_X} = 
 r_{Y_i}(\pmb{\alpha}_Y) \frac{\partial r_{X_i}(\pmb{\alpha}_X)}{\partial \pmb{\alpha}_X}
	\begin{bmatrix}
		1\\
		t_{1i} \\
		t_{2i} \\
...
So what does our matrix $A$ looks like?
