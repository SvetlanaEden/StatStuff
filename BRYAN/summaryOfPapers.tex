...
\pmb{\psi}_{Y_i} = 
	\begin{bmatrix}
     ...
     ~\\
    \widehat{r_{X_i}r_{Y_i}}(\pmb{\alpha}_Y, \pmb{\alpha}_X, ~\pmb{\beta}_{YX}, ~T_i) - a(t) \\
 \widehat{r_{X_i}^2} (\pmb{\alpha}_X, ~\pmb{\beta}_{X^2},~T_i) - b(t)\\
 \widehat{r_{Y_i}^2} (\pmb{\alpha}_Y, ~\pmb{\beta}_{Y^2},~T_i) - c(t)\\
...
Now let's figure out $\frac{\partial \pmb{\psi}_{LM_{r^2_Y}}}{\partial \pmb{\alpha}_Y}$. Let's remind ourselves that for linear regression, the score equation looks like this: 
\[
\pmb{\psi}_{LM_{r^2_Y}} = 
	\begin{bmatrix}
		res_i\\
...
Where $res_i = r^2_i(\pmb{\alpha}) - \pmb{\beta}\pmb{t}_i$
\[
\frac{\partial \pmb{\psi}_{LM_{r}}}{\partial \pmb{\alpha}} = 
	\begin{bmatrix}
		2\cdot r_i(\pmb{\alpha}) \frac{\partial r_i(\pmb{\alpha})}{\partial \pmb{\alpha}} \\
		t_{1i} \cdot 2 \cdot r_i(\pmb{\alpha}) \frac{\partial r_i(\pmb{\alpha})}{\partial \pmb{\alpha}}\\
		t_{2i} \cdot 2 \cdot r_i(\pmb{\alpha}) \frac{\partial r_i(\pmb{\alpha})}{\partial \pmb{\alpha}}\\
		4(r^2_i(\pmb{\alpha}) - \pmb{\beta}\pmb{t}_i)\cdot r_i(\pmb{\alpha}) \frac{\partial r_i(\pmb{\alpha})}{\partial \pmb{\alpha}}\\
 	\end{bmatrix} 
\]
