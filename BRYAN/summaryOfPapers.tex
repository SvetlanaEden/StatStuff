...
As a result:
  ...
  \pmb{A}_{Y,2,2}
   =-\sum_i^n\begin{bmatrix}
      ...
      %%%%%%%%%
      -\left( \frac{\sum_{\left\{m:~y_m = t_{(1)}\right\}} \delta_m}{t_{(1)} - t_{(0)}}  \right)   \frac{     \sum_{l\in \mathcal{R}(t_{(1)})}  e^{\pmb{z}_l\pmb{\beta}} z_{lj}  }{\left(   \sum_{l\in \mathcal{R}(t_{(1)})} e^{\pmb{z}_l\pmb{\beta}}  \right)^2} & -1 & 0 \\
      %%%%%%%%%
      -\left( \frac{\sum_{\left\{m:~y_m = t_{(2)}\right\}} \delta_m}{t_{(2)} - t_{(1)}}  \right)   \frac{     \sum_{l\in \mathcal{R}(t_{(2)})}  e^{\pmb{z}_l\pmb{\beta}} z_{lj}  }{\left(   \sum_{l\in \mathcal{R}(t_{(2)})} e^{\pmb{z}_l\pmb{\beta}}  \right)^2} & 0 & -1 \\
  \end{bmatrix}
  \]
