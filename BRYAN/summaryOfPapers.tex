...
\section{To-Do List}
\begin{enumerate}
  \item Compute integrals for $\rho^*$
  \item Look at papers that estimate $\rho$ using copulas: do they do Partial rho?
  \item program you code to save point estimate and CIs
  \item change your code so if ACCRE's jobs times out, you could continue it again from where it stopped.
