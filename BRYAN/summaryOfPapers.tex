...
\begin{enumerate}
  ...
  \item In order to simulate Clayton's family I used package copula. I've checked my simulation thoroughly and feel comfortable to use them. That said, because it is not clear what mechanizm of simulation was used in Shih\&Lous paper, we don't have to stick to their scenario. Currently, it is: Clayton' family with about 0.1 kendall's tau. Each variable has exponential marginal with l=1 and l=2. Censoring is 30\% in each group and the censoring interval is from time 0 to 2.3, and uniformly distributed. Please let me know your suggestions about the simulatons.
