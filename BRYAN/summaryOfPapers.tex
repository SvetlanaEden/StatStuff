...
P\{ &X_{1}\wedge X_{2} = x,~Y_{1}\wedge Y_{2} = y \} 
      ...
      &= 2S(dx, dy)\left\{\cancel{S(x,y)} +  \cancel{S(x,y^-)} - \cancel{S(x,y)} + \cancel{S(x^-,y)} - \cancel{S(x,y)} +  S(x^-,y^-) - \cancel{S(x,y^-)} - \cancel{S(x^-,y)} + \cancel{S(x,y)}\right\}\\
      &~~~~~~~~~~~~~~~~~~~~~~~~  + 2S(x,dy)S(dx, y)= \\
      &= 2S(dx, dy)S(x^-,y^-) + 2S(x,dy)S(dx, y)= \\
      &= 2S(dx, dy)S(x^-,y^-) + 2(S(x^-,dy) - S(dx,dy))(S(dx, y^-) - S(dx, dy))= \\
      &= 2S(dx, dy)S(x^-,y^-) + 2S(x^-,dy)S(dx, y^-) + S(dx,dy)(S(dx, dy) - S(dx, y^-) - S(x^-,dy))= \\
      &= 2S(dx, dy)S(x^-,y^-) + 2S(x^-,dy)S(dx, y^-) + S(dx,dy)(S(x^-, y^-) - S(x^-, y) - S(x, y^-) + S(x, y)\\
...
\subsubsection{M-estimation for partial and conditional correlation}
