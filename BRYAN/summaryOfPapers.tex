...
$$
  ...
  \end{aligned}
$$
The minuses result from the fact that the result of \cite{stute1995central} holds for Kaplan-Meier (not for CDF).
...
\subsection{M-estimation for Cumulative hazard using Stute's results.}
