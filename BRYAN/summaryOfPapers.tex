...
Also:
  ...
  \begin{aligned}
    ...
    %%%%
    ~~~~~\text{and}~~~~~ \frac{\partial S_{Y_i}}{\partial \lambda_k} =   -e^{-\Lambda(y_i)e^{\pmb{z}_i\pmb{\beta}}}\cdot e^{\pmb{z}_i\pmb{\beta}} (t_{(k)} - t_{(k-1)})
  \end{aligned}
  $$
Therefore
  ...
  \begin{aligned}
    ...
    %%%
    \frac{\partial PSR_{Y_i}}{\partial \lambda_k} & = \left( e^{-\Lambda(y_i)e^{\pmb{z}_i\pmb{\beta}}}  + \delta_i e^{-\Lambda(y_i^-)e^{\pmb{z}_i\pmb{\beta}}} \right) e^{\pmb{z}_i\pmb{\beta}} (t_{(k)} - t_{(k-1)})  ~~~~  &i,k:~~~y_i > t_{(k)}\\
    %%%
...
{\tiny{
  ...
  \begin{aligned}
    ...
    %%%
    \frac{\partial \pmb{PSR}}{\partial \lambda_2} & = \left[ 0,    ~~~0,  ~~~0,  ~~~\left( e^{-\Lambda(y_4)e^{\pmb{z}_4\pmb{\beta}}}  \right)  e^{\pmb{z}_2\pmb{\beta}}  , ~~~\left( e^{-\Lambda(y_5)e^{\pmb{z}_5\pmb{\beta}}}   + \delta_5 e^{-\Lambda(y_4)e^{\pmb{z}_5\pmb{\beta}}}  \right)  e^{\pmb{z}_5\pmb{\beta}}   \right]   \Delta t_{2}  \\
  \end{aligned}
  $$
}}
